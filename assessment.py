...
def all_odd(numbers):
    ...
    For example::
        ...
        []
    """
    odd = [] # creating an empty list to put odd numbers in
    for num in numbers: # starting for loop to iterate over the list numbers
        if num % 2 == 1: # dividing by 2 to get a modulus of 1 for odd numbers
            odd.append(num) # creating a new list with the answers from the for loop
    return odd # returning the new list
...
def print_indices(items):
    ...
    Output should look like this::
        ...
        2 Volvo
    """
    for idx, val in enumerate(items): # using method for extra study
        print idx, val
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    return list(set(foods1) & set(foods2)) # interesction - set math
...
def every_other_item(items):
    ...
    return items[::2] # items[start_index: end_index: step]
...
def largest_n_items(items, n):
    ...
    import heapq # using built in function in python
    new_list = heapq.nlargest(n, items) # using method .nlargest
    print sorted(new_list)[-n:] # printing them in ascending order
